...
export default class Board extends React.Component {
  ...
  componentDidMount() { 
    this.drake = Dragula([this.swimlanes.backlog.current, this.swimlanes.complete.current, this.swimlanes.inProgress.current]);
  ...
  updateClient(el, target, _, sibling) {
    ...
    const updatedClients = clientsList.filter((client) => (
      client.id !== clientThatMovedClone.id
    ));
